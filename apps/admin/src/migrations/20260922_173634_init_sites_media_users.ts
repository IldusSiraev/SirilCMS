...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "sites" (
  	...
  	"settings_smtp_host" varchar,
  	"settings_smtp_port" numeric,
  	"settings_smtp_user" varchar,
  	"settings_smtp_pass" varchar,
  	"settings_analytics_id" varchar,
  	"logo_id" integer,
