export function yandexMetrikaTag(counterId: string | null | undefined): { script: string; noscript: string } | null {
...
ym(${id}, "init", { clickmap:true, trackLinks:true, accurateTrackBounce:true });`
  const noscript = `<div><img src="https://mc.yandex.ru/watch/${id}" style="position:absolute; left:-9999px;" alt="" /></div>`
