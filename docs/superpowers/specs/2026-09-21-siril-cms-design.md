...
- мультисайт (N сайтов на одной платформе) — спланирован как v2, см. §10
...
## 11. Оценка MVP (1 разработчик)

| # | Блок | Оценка |
|---|---|---|
| 1 | Инфрафабрика: compose, Caddy, Payload+PG, Nuxt-каркас, env | 3 дня |
